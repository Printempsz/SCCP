                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('goods.publish') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <label class="radio-inline">
                                        <input type="radio" name="categories_id" value="1">手机相关
                                    </label>
                                    <label class="radio-inline">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <label class="radio-inline">
                                        <input type="radio" name="categories_id" value="1" checked>好呀好呀！
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="categories_id" value="0">那可不行！
                                    </label>
                                </div>
                            </div>
